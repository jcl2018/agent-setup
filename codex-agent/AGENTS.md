...
These instructions apply to the `codex-agent/` workspace inside this repo's multi-tool container root. Treat `codex-agent/` as the workspace root for all relative paths below.
