...
6. Mirror Codex shared-skill changes into `~/.codex/.agents-home/skills/` in the same pass.
7. Validate the result with a sync preview and a stale-reference scan.
