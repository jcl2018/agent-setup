...
description: Audit or improve a repository for private or public GitHub use. Use when Codex needs to prepare a repo for internal sharing, public release, contributor onboarding, or publication cleanup across multiple repos.
---
