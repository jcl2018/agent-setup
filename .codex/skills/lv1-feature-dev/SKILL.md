...
2. Pull in `~/.codex/skills/lv0-code-polisher/SKILL.md` because feature implementation changes code.
...
6. Pull in `~/.codex/skills/lv0-doc-writer/SKILL.md` when the PRD becomes a meaningful deliverable or needs heavier documentation support than the normal feature flow.
