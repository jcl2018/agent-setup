...
3. Use `~/.codex/workflows/` for process, `~/.codex/knowledge/` for durable facts, `~/.codex/templates/` for structured outputs, and `~/.codex/checklists/` for wrap-up validation.
