...
Use this {{WRAPPER_NOUN}} when the job is to create, rename, extend, or standardize shared skills and agents inside this home-agent mirror. It turns authoring into a repeatable workflow instead of a memory exercise.
