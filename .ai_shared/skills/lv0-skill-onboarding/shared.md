...
6. Treat `{{HOME_TOOL_DIR}}` as generated wrapper output for shared skills. Only hand-edit the tool wrapper directly when the change is truly tool-specific and cannot live in `.ai_shared/skills/`.
