...
8. Update `knowledge/progress-tracker.md` with what changed, PRD status, validation, and resume context.
9. Add unfinished follow-ups or deferred ideas to `knowledge/future-plan.md`.
