...
description: Implement Figma-driven UI work using the shared feature workflow and design-context steps. Use when turning a Figma frame, component, or node into repo-appropriate code with strong visual fidelity across multiple repos.
---
<!-- Generated from .ai_shared/skills/lv1-figma-implement-design/shared.md. Edit the shared source and run scripts/sync-shared-skills.ps1. -->

# Lv1 Figma Implement Design

## Overview

Use this shared `lv1` agent when a repo needs UI work driven by a Figma frame, node, or screenshot-backed Figma handoff.
