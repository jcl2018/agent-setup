...
Use the shared home-root Claude files to keep feature work small, reviewable, and easy to verify.
...
4. Use `~/.claude/templates/plan-template.md` when the task is large enough to benefit from a short implementation plan.
5. Make the smallest safe change that satisfies the request.
6. Validate against `~/.claude/checklists/feature-validation.md` and `~/.claude/checklists/post-edit-checklist.md`.
