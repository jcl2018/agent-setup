...
7. If the repo itself exists to define reusable skills or agents, also read `~/.ai_shared/knowledge/agent-authoring.md` and route into `~/.claude/skills/lv0-skill-onboarding/SKILL.md` for the creation work.
