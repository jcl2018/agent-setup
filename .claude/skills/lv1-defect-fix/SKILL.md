...
4. Use `~/.claude/templates/defect-report-template.md` when the issue needs a written diagnosis or handoff note.
...
7. Validate against `~/.claude/checklists/bugfix-verification.md` and `~/.claude/checklists/post-edit-checklist.md`.
