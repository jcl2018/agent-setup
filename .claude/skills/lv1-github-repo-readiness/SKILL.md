...
description: Audit or improve a repository for GitHub-facing sharing, contributor surfaces, and publication decisions after the local repo audit baseline is in place. Use when preparing a repo for internal sharing, public release, contributor onboarding, or publication cleanup across multiple repos.
---
...
Use this shared `lv1` skill when a repository needs GitHub-facing cleanup, private handoff hardening, or public-release preparation after the generic local-repo audit baseline is already in place.
