...
3. Read the most relevant repo context from `~/.claude/knowledge/`, especially `repo-map.md`, `test-commands.md`, `progress-tracker.md`, and `future-plan.md`.
...
11. Update `~/.claude/knowledge/progress-tracker.md` and `~/.claude/knowledge/future-plan.md` when the shared workflow changes or follow-up repo work remains.
